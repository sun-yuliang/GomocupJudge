...
class new_protocol(object):
    ...
    def __init__(self, cmd, board, timeout_turn=30 * 1000, timeout_match=180 * 1000, max_memory=350 * 1024 * 1024, game_type=1, rule=0, folder="./", working_dir="./", tolerance=1000):
        self.cmd = cmd
        ...
        self.process = subprocess.Popen(shlex.split(cmd), shell=False, stdin=subprocess.PIPE, stdout=subprocess.PIPE, bufsize=1, close_fds="posix" in sys.builtin_module_names, cwd=self.working_dir)
...
def main():
    engine = new_protocol(cmd="C:/Users/sunyu/gomoku/GomocupJudge/bin/Yixin2018.exe",
                          ...
                          game_type=1,
                          rule=0,
                          folder="C:/Users/sunyu/gomoku/GomocupJudge/bin/",
                          working_dir="C:/Users/sunyu/gomoku/GomocupJudge/bin/",
                          tolerance=1000)
